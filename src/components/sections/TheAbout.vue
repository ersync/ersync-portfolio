    ...
    <div class="container relative z-10">
      ...
      <FadeUpOnScroll :delay="100">
        <div class="grid items-stretch gap-5 lg:grid-cols-[1.15fr_0.85fr]">
          <article
            class="relative overflow-hidden rounded-[2rem] border border-cyan-200/15 bg-[#091527]/95 p-6 shadow-[0_24px_70px_rgba(0,0,0,0.35)] sm:p-9"
          >
            <div
            ...
            <div class="relative flex h-full flex-col justify-between">
              <div>
                <h3
                  class="max-w-xl font-display text-3xl font-semibold leading-tight tracking-[-0.04em] text-white sm:text-5xl"
                >
              ...
              <div class="mt-10 grid gap-4 border-t border-white/10 pt-6 sm:grid-cols-3">
                <div v-for="item in capabilities" :key="item.title">
                  ...
                  <p class="mt-1 text-sm leading-5 text-slate-400">{{ item.description }}</p>
                </div>
              </div>
            </div>
          </article>
